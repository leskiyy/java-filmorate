...
create TABLE IF NOT EXISTS PUBLIC.FILM_DIRECTORS (
	...
	CONSTRAINT FILM_DIRECTORS_DIRECTORS_FK FOREIGN KEY (DIRECTOR_ID) REFERENCES PUBLIC.DIRECTORS(DIRECTOR_ID)
);
...
create TABLE IF NOT EXISTS PUBLIC.EVENTS (
	...
	CONSTRAINT EVENTS_USERS_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(USER_ID)
);
